            ...
            <div className="sub-sub-main">
                ...
                <div className="login">
                    <div>
                        ...
                        <div>
                            <input type="text" placeholder="E-mail de acesso" className="name" value={email} required onChange={(e) => {handleEmailChange(e)}}/>
                        </div>
                        <div className="Senha">
                            <div>
                                <input type="password" placeholder="Senha" className="name" value={password} required onChange={(e) => {handlePasswordChange(e)}} />
                            </div>
                        </div>
                        <div>
                            <p className="link">
